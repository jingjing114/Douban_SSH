					...
					<div class="row">
						...
						<div class="col-md-3 col-sm-12 text-right">
							<ul class="nav-icons">
								...
								<li><a href="useraction_selectDoubanUserInfo?user.username=${sessionScope.user.getUsername()}"><span>${sessionScope.user.getUsername()}</span></a></li>
							</ul>
						</div>
					</div>
				</div>
		...
		<c:forEach var="r" items="${requestScope.reviewInfo}" varStatus="status">
         ...
         <div class="col-md-12 text-center">
					...
					<div class="col-md-8">
						...
						<a href="#" onclick="publish()">编辑个人资料</a>
