...
<script src="JSP/js/rickshaw.js"></script>
  ...
  <body >
    ...
    <input type="text" name="director.directorname" placeholder="输入要查找的演员名" class="input-small"  style="width:550px;"><input type="submit" value="搜索"  style="color:#F73F52">
    </form>
    ...
    <span style="color:#F73F52;">${director.getDirectorname()}</span><br>
   <button type="button" class="btn btn-info" style="margin-right: 5px;">  <a href="JSP/directorUpdate.jsp?directorphoto=${director.getDirectorphoto()}&directorid=${director.getDirectorid()}&directorname=${director.getDirectorname()}&directorsex=${director.getDirectorsex()}&directorsign=${director.getDirectorsign()}&directorbirthday=${director.getDirectorbirthday()}&directorwork=${director.getDirectorwork()}&directorborned=${director.getDirectorborned()}&directorintroduction=${director.getDirectorintroduction()}" style="color:;">修改</a>&nbsp;</button>
  <button type="button" class="btn btn-info" style="margin-right: 5px;">  <a href="adminaction_deleteDirector?director.directorid=${director.getDirectorid()}"  style="color:;">删除</a>&nbsp;</button>
